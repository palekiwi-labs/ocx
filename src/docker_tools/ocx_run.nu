use ./utils.nu [image_exists, resolve-run-container-name, resolve-dockerfile-path, resolve-extra-volumes]
use ./build.nu
use ../ports.nu
use ../workspace.nu
use ../config
...
export def --wrapped main [...args] {
    ...
    # No port publishing for headless run containers
